...
def create_ssh_key(data):
    ...
    serialized_private_key, private_key = generate_private_key()
    
    serialized_public_key = generate_public_key(private_key)
    ...
    save_keys_to_files(serialized_private_key, serialized_public_key)
    return {
        'status': 'success',
